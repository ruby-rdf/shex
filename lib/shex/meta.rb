...
module ShEx::Meta
  ...
  BRANCH = {
    ...
    :_inlineShapeAtom_1 => {
      ...
      "PATTERN" => [:nonLitNodeConstraint, :_inlineShapeAtom_4],
      "~" => [:nonLitNodeConstraint, :_inlineShapeAtom_4],
    },
    :_inlineShapeAtom_2 => {
    ...
    :_inlineShapeDefinition_4 => {
      "&" => [:_inlineShapeDefinition_3, :_inlineShapeDefinition_1],
    ...
    :_litNodeConstraint_10 => {
      ...
      "PATTERN" => [:xsFacet, :_litNodeConstraint_9],
      "TOTALDIGITS" => [:xsFacet, :_litNodeConstraint_9],
      "~" => [:xsFacet, :_litNodeConstraint_9],
    },
    ...
    :_litNodeConstraint_6 => {
      ...
      "PATTERN" => [:xsFacet, :_litNodeConstraint_5],
      "TOTALDIGITS" => [:xsFacet, :_litNodeConstraint_5],
      "~" => [:xsFacet, :_litNodeConstraint_5],
    },
    ...
    :_litNodeConstraint_8 => {
      ...
      "PATTERN" => [:xsFacet, :_litNodeConstraint_7],
      "TOTALDIGITS" => [:xsFacet, :_litNodeConstraint_7],
      "~" => [:xsFacet, :_litNodeConstraint_7],
    },
    ...
    :nonLitNodeConstraint => {
      ...
      "PATTERN" => [:_nonLitNodeConstraint_2],
    ...
    :_nonLitNodeConstraint_2 => {
      ...
      "PATTERN" => [:stringFacet, :_nonLitNodeConstraint_5],
      "~" => [:stringFacet, :_nonLitNodeConstraint_5],
    },
    :_nonLitNodeConstraint_3 => {
      ...
      "OR" => [],
      "PATTERN" => [:_nonLitNodeConstraint_4],
      :PNAME_LN => [],
      :PNAME_NS => [],
      "PREFIX" => [],
      :REPEAT_RANGE => [],
    ...
    :_nonLitNodeConstraint_4 => {
      ...
      "PATTERN" => [:stringFacet, :_nonLitNodeConstraint_3],
      "~" => [:stringFacet, :_nonLitNodeConstraint_3],
    },
    :_nonLitNodeConstraint_5 => {
      ...
      "OR" => [],
      "PATTERN" => [:_nonLitNodeConstraint_6],
      :PNAME_LN => [],
      :PNAME_NS => [],
      "PREFIX" => [],
      :REPEAT_RANGE => [],
    ...
    :_shapeAtomNoRef_1 => {
      ...
      "PATTERN" => [:nonLitNodeConstraint, :_shapeAtomNoRef_4],
      "~" => [:nonLitNodeConstraint, :_shapeAtomNoRef_4],
    },
    :_shapeAtomNoRef_2 => {
    ...
    :_shapeAtom_1 => {
      ...
      "PATTERN" => [:nonLitNodeConstraint, :_shapeAtom_4],
      "~" => [:nonLitNodeConstraint, :_shapeAtom_4],
    },
    :_shapeAtom_2 => {
    ...
    :_shapeDefinition_5 => {
      "&" => [:_shapeDefinition_4, :_shapeDefinition_1],
    ...
    :_shapeExpression_1 => {
      ...
      "PATTERN" => [:shapeAtomNoRef, :_shapeExpression_4],
