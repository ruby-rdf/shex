...
module ShEx::Meta
  ...
  BRANCH = {
    ...
    :valueSetValue => {
      "." => [:_valueSetValue_2],
      :DECIMAL => [:_valueSetValue_1],
      :DOUBLE => [:_valueSetValue_1],
      :INTEGER => [:_valueSetValue_1],
      :IRIREF => [:_valueSetValue_1],
      :LANGTAG => [:_valueSetValue_1],
      :LANG_STRING_LITERAL1 => [:_valueSetValue_1],
      :LANG_STRING_LITERAL2 => [:_valueSetValue_1],
      :LANG_STRING_LITERAL_LONG1 => [:_valueSetValue_1],
      :LANG_STRING_LITERAL_LONG2 => [:_valueSetValue_1],
      :PNAME_LN => [:_valueSetValue_1],
      :PNAME_NS => [:_valueSetValue_1],
      :STRING_LITERAL1 => [:_valueSetValue_1],
      :STRING_LITERAL2 => [:_valueSetValue_1],
      :STRING_LITERAL_LONG1 => [:_valueSetValue_1],
      :STRING_LITERAL_LONG2 => [:_valueSetValue_1],
      "false" => [:_valueSetValue_1],
      "true" => [:_valueSetValue_1],
    },
    :_valueSetValue_1 => {
  ...
  CLEANUP = {
    ...
    :_valueSetValue_3 => :plus,
    :_valueSetValue_4 => :star,
    :_valueSetValue_5 => :merge,
    :_valueSet_1 => :star,
    :_valueSet_2 => :merge,
  }.freeze
  PASS = [
